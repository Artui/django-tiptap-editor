...
| `TIPTAP_EXTRA_EXTENSIONS` | `[]` | Extra extensions accepted by config validation: a list of names, or a mapping of name to the HTML vocabulary each emits. See [Extending](extending.md#declaring-what-an-extension-emits). |
